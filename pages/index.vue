...
<div class="container search">
  <input type="text" placeholder="Seach" @keyup.enter="$fetch" v-model.lazy="searchInput" />
  ...
  methods:{
    async getMovies() {
      const data = axios.get(
         'https://api.themoviedb.org/3/movie/now_playing?api_key=ab208a260674bde0123fc7ea986c37a7&language=en-US&page=1'
      )
    ...
    async searchMovies() {
      const data = axios.get(
        `https://api.themoviedb.org/3/search/movie?api_key=ab208a260674bde0123fc7ea986c37a7&language=en-US&page=1&query=${this.searchInput}`
